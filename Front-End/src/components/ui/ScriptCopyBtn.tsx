        ...
        <div className="mb-2 flex items-center justify-between">
          {showMultiplePackageOptions && (
            <div className="relative">
              <div className="inline-flex overflow-hidden rounded-md border border-gray-200 text-xs dark:border-gray-800">
                {packageManagers.map((pm, index) => (
                  <div key={pm} className="flex items-center">
                    ...
                    <Button
                      ...
                      {packageManager === pm && (
                        <motion.div
                          className="absolute inset-x-0 bottom-[1px] mx-auto h-0.5 w-[90%] bg-gray-900 dark:bg-gray-50"
                          layoutId="activeTab"
                          initial={false}
                          transition={{
                            type: "spring",
        ...
        <div className="relative flex items-center">
          <div className="min-w-[300px] grow font-mono">
            {highlightedCode ? (
              ...
              <pre className="rounded-md border border-gray-200 bg-white p-2 px-4 font-mono dark:bg-black dark:border-gray-800">
                {command}
              </pre>
            )}
          </div>
