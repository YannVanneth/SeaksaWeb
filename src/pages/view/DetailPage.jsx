...
export default function DetailPage() {
  ...
  return (
    <section className="dark:bg-primaryDark">
      <nav className="ml-16 pt-4" aria-label="Breadcrumb">
        <ol className="flex items-center gap-1 text-sm text-gray-600 dark:text-textDark">
          <li>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8">
            ...
            <div>
              <div className="max-w-lg md:max-w-none">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-textDark sm:text-3xl">
                  {data.title}
                </h2>
                ...
                <div className="flex items-center gap-2 mt-4">
                  <FaVideo
                    size={24}
                    className="text-gray-600 dark:text-textDark"
                  />
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8 ">
            <div>
              ...
              <ul className="mt-4 text-gray-700 list-none dark:text-textDark ">
            ...
            <div className="max-w-lg md:max-w-none dark:text-textDark">
      ...
      <section>
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-8">
            <div>
              <h2 className="text-3xl font-semibold text-gray-900  dark:text-textDark mb-4">
