    ...
    <div className={cn("relative", className)}>
      <div
        ...
        <img
          ...
          width={1920}
          height={1080}
          className=" mt-3 w-full h-[200px] md:h-full xl:h-[360px] object-cover rounded-md border border-gray-200 shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8] dark:border-gray-800"
        />
